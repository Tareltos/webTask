...
public class CandiesStAXBuilderTest {
    ...
    public CandiesStAXBuilderTest() throws DatatypeConfigurationException {
    }
    ...
    @Test(groups = "Parsers")
    public void candiesStAXBuilderCountTest() {
        int expected = 3;
        int result = builder.getCandies().size();
        LOGGER.log(Level.INFO, "TEST: candiesStAXBuilderCount, expected: " + expected + ", result: " + result);
